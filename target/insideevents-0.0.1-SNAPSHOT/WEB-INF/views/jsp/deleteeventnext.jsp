...
<form action="deletecarsfinal" method="post" class="work-request">
			...
			<input type="hidden" value="${tdate }" name="tdate"/> 
				...
				<tr align="center">
				<td><input type="radio" name="option" id="option" value="${list.eventname }?${list.fdate}?${list.tdate}?${list.cost}?${list.address}"/></td>
