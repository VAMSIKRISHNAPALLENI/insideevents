...
<script type="text/javascript">
		...
		function fun()
		{
			var doc=document.getElementById("eventbooking").value;
			if((doc==null)||doc==" ")
				{
...
<s:form action="eventbooking" method="post" class="work-request" id="eventbooking" value=" "  comandName="eventbooking" >
			...
			<input type="hidden" value="${tdate }" name="tdate"/> 
				...
				<td><input type="radio"  name="option" id="option" Style="opacity:1" value="${list.eventname }?${list.fdate}?${list.tdate}?${list.cost}?${list.address}"/><label for="option"><a href="#"  onclick="setMV('${list.eventname }?${list.fdate}?${list.tdate}?${list.cost}?${list.address}')"><img src="assets\img\l=${list.eventname}.png" width="40px" height="40px"  ></img></a></label> </td>
